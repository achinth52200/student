...
**StudentSync** is a comprehensive, AI-powered student life management platform designed to help students balance academic performance, financial health, and mental well-being in one seamless interface.

## 🚀 Key Features

### 1. AI-Driven Study Planner
- **Intelligent Scheduling**: Leverages Genkit and Gemini to transform a list of deadlines and priorities into a structured study timetable.
- **Export to PDF**: Generate and download your optimized schedule instantly for offline reference.
- **Task Integration**: Automatically creates reminders based on the generated study blocks.
...
- **AI/GenAI**: Google Genkit, Gemini 1.5/2.0 Models (Flash, TTS, Image Extraction).
- **Backend/Database**: Firebase (Firestore, Auth), LocalStorage for session-persistent guest data.
- **Utilities**: jsPDF for document generation, Recharts for financial visualization.

---
*StudentSync - Seamlessly sync your student life.*